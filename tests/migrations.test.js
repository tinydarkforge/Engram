...
describe('Migrations', () => {
  ...
  before(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'engram-migrate-'));
    const index = {
      v: '4.0.0',
    ...
    pathsModule.resolveEngramPath = () => tmpDir;
    restoreResolve = () => { pathsModule.resolveEngramPath = originalResolve; };
